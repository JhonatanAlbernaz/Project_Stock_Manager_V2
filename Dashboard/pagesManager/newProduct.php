            ...
            <div class="row">
             <form action="../../controllers/saveProduct.php" method="POST" class="form-widht-100px row g-2" enctype="multipart/form-data">
              ...
              <div class="form-group input-group-sm font-size-register col-md-6">
               ...
               <input type="text" class="form-control form-control-md text-dark" id="title" name="title" required>
              </div>

              <div class="form-group input-group-sm font-size-register col-md-6">
               <label for="name" class="form-label">Sub-Título</label>
               <input type="text" class="form-control form-control-md text-dark" id="subtitle" name="subtitle" required>
              </div>
